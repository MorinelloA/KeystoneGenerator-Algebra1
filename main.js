...
function main(){
    alert('Correct');
    hideAllQuestions();
    var anchor1 = 'Aperations with Real Numbers and Expressions';
    ...
    content[10] = 'Interpret solutions to problems in the context of the problem situation';
    ...
    content[12] = 'Interpret solutions to problems in the context of the problem situation';
    ...
    content[15] = 'Interpret solutions to problems in the context of the problem situation';
    content[16] = 'Write and/or solve a system of linear inequalities using graphing';
    content[17] = 'Interpret solutions to problems in the context of the problem situation';
